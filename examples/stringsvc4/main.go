...
import (
	...
	natstransport "github.com/chadgrant/kit/transport/nats"
...
// Endpoints are a primary abstraction in kit. An endpoint represents a single RPC (method in our service interface)
